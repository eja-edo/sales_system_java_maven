...
public class ttkh extends javax.swing.JPanel {
    ...
    public ttkh() {
        initComponents();
//        Image image=Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/thekhachang.png"));
//        Image scaledImg=image.getScaledInstance(2500, 1250, Image.SCALE_SMOOTH);
